...
namespace AuthServerWithDomain.Controllers;
...
using AuthServerWithDomain.ViewModels;
using AuthServerWithDomain.Extensions;
using AuthServerWithDomain.Attributes;
